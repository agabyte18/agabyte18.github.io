...
CREATE TABLE countries (
  ...
  CONSTRAINT FK_region_id FOREIGN KEY (region_id) REFERENCES regions (region_id) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE locations (
  ...
  CONSTRAINT FK_country_id FOREIGN KEY (country_id) REFERENCES countries (country_id) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE departments (
  ...
  CONSTRAINT FK_location_id FOREIGN KEY (location_id) REFERENCES locations (location_id) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE employees (
  ...
  CONSTRAINT CC_salary CHECK (salary > 0),
  CONSTRAINT FK_department_id FOREIGN KEY (department_id) REFERENCES departments (department_id) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT FK_job_id FOREIGN KEY (job_id) REFERENCES jobs (job_id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE job_history (
  ...
  job_id varchar(10) NOT NULL,
  department_id int,
  CONSTRAINT CC_date_interval CHECK (emp_end_date > emp_start_date),
  CONSTRAINT UK_emp_id_start_date UNIQUE (employee_id, emp_start_date),
  CONSTRAINT FK_jh_job_id FOREIGN KEY (job_id) REFERENCES jobs (job_id) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT FK_jh_emp_id FOREIGN KEY (employee_id) REFERENCES employees (employee_id) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT FK_jh_dept_id FOREIGN KEY (department_id) REFERENCES departments (department_id) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
